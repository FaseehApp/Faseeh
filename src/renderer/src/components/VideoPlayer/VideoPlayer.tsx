...
const VideoPlayer: React.FC<VideoPLayerProps> = ({ videoStreamlink, linkType }) => {
  ...
  return (
    <div ref={containerRef} className="relative container w-[600px] h-[400px] bg-black group">
      { isLoading ? <IsLoading />: <StreamVideo 
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
        ...
        <div className="relative w-full h-1 cursor-pointer group/progress">
          ...
          <div className="absolute w-3 h-3 transition-opacity -translate-y-1 bg-red-500 rounded-full opacity-0 group-hover/progress:opacity-100"
