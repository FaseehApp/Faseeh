...
var require_charmap = __commonJS({
  "src/charmap.json"(exports, module) {
...
var require_syllable = __commonJS({
  "src/syllable.js"(exports, module) {
    "use strict";
    var pluralize2 = __require("pluralize");
...
// data/easy_words.ts
var easyWords, easy_words_default;
var init_easy_words = __esm({
  "data/easy_words.ts"() {
    "use strict";
    easyWords = [
      "a",
    ...
    var Readability = class _Readability {
      ...
      */
      ...
      difficultWords(text, syllableThreshold = 2) {
        ...
        for (let word of textList) {
          const normalized = this.presentTense(pluralize(word.toLocaleLowerCase()));
